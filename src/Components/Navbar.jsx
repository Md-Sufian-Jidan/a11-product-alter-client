    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div className="navbar-center">
                <p className="text-xl text-purple-400 mr-6">Product Alter</p>
            </div>
                ...
                </label>
                {
                    ...
                    <div className="dropdown dropdown-end">
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                            <div title={user?.displayName} className="md:w-10 w-6 rounded-full">
                                <img alt="Profile Logo" src={user?.photoURL} />
                            </div>
                        </div>
                    </div>
                }
                <ul className='p-2 bg-base-100 flex '>
                    {!user && <li><Link className='btn btn-success' to="/login">Login</Link></li>}
                </ul>
            </div>
        </div>
    );
